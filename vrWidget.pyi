...
from vrQObject import vrQObject
...
class vrWidget:
    ...
    def __init__(self, object: vrQObject, uifile: str, className: str, parent: vrQObject, name: str) -> None: ...
    ...
    def connect(self, sender: str, signal: str, function: object) -> None: ...
