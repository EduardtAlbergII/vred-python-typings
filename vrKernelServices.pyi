...
class vrAnnotationService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrAnnotationService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrAnnotationTypes:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrAnnotationTypes: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrAssetsService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrAssetsService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
    ...
    def isWindowType(self) -> bool: ...
    def killTimer(self, id: int) -> None: ...
    def loadGeometriesByUUID(self, uuids: Sequence[str], parentNode: vrdNode = vrNodeService.getRootNode()) -> List[vrdNode]: ...
    def loadMetadataSetsByUUID(self, uuids: Sequence[str]) -> List[vrdMetadataSet]: ...
    def loadSceneplatesByUUID(self, uuids: Sequence[str], parentNode: vrdNode = vrNodeService.getRootNode()) -> List[vrdNode]: ...
    def metaObject(self) -> QMetaObject: ...
    def moveToThread(self, thread: QThread) -> None: ...
    def objectName(self) -> str: ...
    def objectNameChanged(self) -> None: ...
...
class vrCADFileTypes:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrCADFileTypes: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrCameraFromAtUp:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrCameraFromAtUp: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __rlshift__(self) -> None: ...
...
class vrCameraService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrCameraService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
    ...
    def createCamera(self, name: str, mode: vrCameraTypes.CameraProjectionMode = vrCameraTypes.CameraProjectionMode.ProjectionPerspective, constraint: vrCameraTypes.CameraConstraint = vrCameraTypes.CameraConstraint.ConstraintNone, sceneGraphParentNode: vrdNode = vrNodeService.getRootNode(), cameraGraphParentNode: vrdNode = vrNodeService.getRootNode()) -> vrdCameraNode: ...
    def createCameraGroup(self, name: str, cameraGraphParentNode: vrdNode = vrNodeService.getRootNode()) -> vrdNode: ...
...
class vrClusterManagerService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrClusterManagerService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrClusterService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrClusterService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrClusterTypes:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrClusterTypes: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrConstraintService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrConstraintService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrDecoreService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrDecoreService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrDeviceService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrDeviceService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrFileIOService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrFileIOService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrGUIService:
    ...
    def openImportDialog(self, files: Sequence[str], parent: vrdNode = vrNodeService.getRootNode()) -> None: ...
    def parent(self) -> QObject: ...
    def property(self, name: str) -> Any: ...
    def receivers(self, signal: bytes) -> int: ...
...
class vrGeometryService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrGeometryService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrGeometryTypes:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrGeometryTypes: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrImageService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrImageService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrImmersiveInteractionService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrImmersiveInteractionService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrImmersiveInteractionTypes:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrImmersiveInteractionTypes: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrImmersiveUiService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrImmersiveUiService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrLensFlareTypes:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrLensFlareTypes: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrLightService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrLightService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrMaterialEntryId:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrMaterialEntryId: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __rlshift__(self) -> None: ...
...
class vrMaterialService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrMaterialService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrMaterialTypes:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrMaterialTypes: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrMetadataService:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrMetadataService: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __setattr__(self) -> None: ...
...
class vrNodeService:
    ...
    def timerEvent(self, event: QTimerEvent) -> None: ...
    def tr(self) -> None: ...
    def traverse(self, func: object, root: vrdNode = getRootNode()) -> None: ...
...
class vrdBRDFMaterial(vrdMaterial):
    __doc__: NoneType
    __module__: str
...
class vrdMaterial(vrdSceneObject):
    __doc__: NoneType
    __module__: str
    nameProperty: str
    tagsProperty: str
...
class vrdPhongMaterial(vrdBRDFMaterial):
    __doc__: NoneType
    __module__: str
    diffuseColorProperty: str
    diffuseColorSpectrumProperty: str
...
class vrdPlasticMaterial(vrdBRDFMaterial):
    __doc__: NoneType
    __module__: str
    diffuseColorProperty: str
    diffuseColorSpectrumProperty: str
...
class vrdWebEngine(vrdUiEngine):
    __doc__: NoneType
    __module__: str
    urlProperty: str
    textureProperty: str
...
class vrdWovenClothMaterial:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrdWovenClothMaterial: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __rlshift__(self) -> None: ...
...
class vrdXRayMaterial(vrdBRDFMaterial):
    __doc__: NoneType
    __module__: str
    baseColorProperty: str
    baseColorSpectrumProperty: str
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrdXRayMaterial: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __rlshift__(self) -> None: ...
...
class vrdXRiteMeasuredMaterial:
    ...
    def __lt__(self) -> None: ...
    def __ne__(self) -> None: ...
    def __new__(cls) -> vrdXRiteMeasuredMaterial: ...
    def __reduce__(self, /): ...
    def __reduce_ex__(self, protocol, /): ...
    def __repr__(self) -> None: ...
    def __rlshift__(self) -> None: ...
