...
class vrVirtualEye:
    ...
    def __init__(self, mat: vrMaterialPtr, camera_beacon: vrNodePtr, texsize: int) -> None: ...
    ...
    def getCameraTransform(self) -> vrNodePtr: ...
    ...
    def setUseCameraSetting(self, name: str) -> None: ...
