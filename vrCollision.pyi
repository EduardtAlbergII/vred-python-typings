...
class vrCollision:
    ...
    def __init__(self, nodesa: list, nodesb: list) -> None: ...
    ...
    def getCollidingNodes(self) -> tuple: ...
    def getCollidingTriangleIndices(self) -> tuple: ...
    def getCollidingTriangles(self, useWorldSpace: bool) -> tuple: ...
    def getCollisionInfo(self, useWorldSpace: bool) -> tuple: ...
    def getCollisionPoint(self, useWorldSpace: bool) -> Pnt3f: ...
